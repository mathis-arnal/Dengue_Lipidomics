...
base_dir <- "/Users/loictalignani/research/project/lipidomics/analysis/PostHoc_Healthy_vs_Severe/D0"
...
group_info <- read_tsv("data/lipidsig_datasets/healthy_vs_sick_patients/group_information_table_healthy_vs_SEVERE_D0.tsv",
...
abundance <- read_tsv("data/lipidsig_datasets/healthy_vs_sick_patients/healthy_SEVERE_lipidomics.tsv",
                      show_col_types = FALSE)
