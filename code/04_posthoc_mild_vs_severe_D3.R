...
base_dir <- "/Users/loictalignani/research/project/lipidomics/analysis/PostHoc_Mild_vs_Severe/D3"
...
group_info <- read_tsv("data/lipidsig_datasets/healthy_vs_sick_patients/group_information_table_MILD_vs_SEVERE_patients_D3.tsv",
...
abundance <- read_tsv("data/lipidsig_datasets/healthy_vs_sick_patients/MILD_SEVERE_lipidomics_D3.tsv",
  show_col_types = FALSE
)
