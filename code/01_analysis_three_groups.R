...
base_dir <- "/Users/loictalignani/research/project/lipidomics/analysis/Three_groups/D0"
...
group_info <- read_tsv("data/lipidsig_datasets/healthy_vs_sick_patients/group_information_table_healthy_vs_sick_patients_D0.tsv")
cat("  Groups found:", unique(group_info$group), "\n")
cat("  Sample count:", nrow(group_info), "\n")

# Load abundance data
cat("Loading abundance data...\n")
abundance <- read_tsv("data/lipidsig_datasets/healthy_vs_sick_patients/healthy_sick_lipidomics.tsv")
