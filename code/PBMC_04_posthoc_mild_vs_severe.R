...
base_dir <- "E:/Dengue_lipidomics/analysis/PBMC/PostHoc_Mild_vs_Severe/D0"
...
group_info <- read_tsv("data/PBMC/group_information_table_MILD_vs_SEVERE_patients_D0.tsv",
